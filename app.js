     ...
     addItem : function(type,des,val){
        ...
        deleteItem : function(type, id){
          ...
          var ids =   data.allItems[type].map(function(current){
            ...
            if(index !==-1){
                data.allItems[type].splice(index, 1); //splice(position at which element is to be deleted, number of elements that have to be deleted from that position )
            }
        },
